...
(defcfun ("gpiod_chip_open_lookup" chop-open-lookup) :pointer
  (descr :string))
...
(defcfun ("gpiod_line_name" line-name) (:pointer :char)
  (line :pointer))

(defcfun ("gpiod_line_consumer" line-consumer) (:pointer :char)
  (line :pointer))
