...
(ovomorph:define-command (read-block 1)
  (with-drive-and-block-number (drive block-number)
    (ovomorph:log "Read drive ~D block ~D" drive block-number)
...
(ovomorph:define-command (write-block 2)
  (with-drive-and-block-number (drive block-number)
    (ovomorph:log "Write drive ~D block ~D" drive block-number)
